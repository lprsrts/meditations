...
// Function to get articles from the generated articles-data.js file
async function fetchArticles() {
    try {
        // Import the articles from the generated file
        // This approach works well with GitHub Pages as it doesn't require fetching external files
        if (!articles.length) {
            try {
                // Dynamic import for the articles data
                const module = await import('./articles-data.js');
                articles = module.articles;
            } catch (importError) {
                console.error('Error importing articles data:', importError);
